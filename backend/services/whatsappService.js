...
class WhatsAppService {
  ...
  /**
   * Template: benne_cafe_booking_confirmation_20260801092638
    ...
    if (this.enabled) {
      const payload = {
        ...
        messages: [{
          kind: 'template',
          template: {
            name: 'benne_cafe_booking_confirmation_20260801092638',
            language: 'en_US',
            components: [
      ...
      return this._post(payload, 'benne_cafe_booking_confirmation_20260801092638');
    } else {
      console.log('\n📲 MOCK WhatsApp (Benne Cafe Valet):');
      console.log(`   To       : ${to}`);
      console.log(`   Template : benne_cafe_booking_confirmation_20260801092638`);
