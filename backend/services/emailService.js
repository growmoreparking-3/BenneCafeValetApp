...
class EmailService {
  constructor() {
    ...
    this.fromName = process.env.EMAIL_FROM_NAME || "Benne Cafe Valet";
  ...
  async sendBookingConfirmation(
    ...
    const subject = `Welcome to Benne Cafe Valet 🚗 — Booking ${bookingId} Confirmed`;
...
<head>
  ...
  <title>Benne Cafe Valet — Booking Confirmed</title>
</head>
<body style="margin:0;padding:0;background:#F9FAFB;font-family:'Segoe UI',Arial,sans-serif;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#6B3FA0,#9B6DD6);padding:32px 32px 24px;text-align:center;">
            ...
            <p style="margin:8px 0 0;color:rgba(255,255,255,0.88);font-size:14px;">Your car is in safe hands at Benne Cafe</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:28px 32px 16px;">
            <p style="margin:0 0 18px;font-size:15px;color:#374151;">Hi <strong>${customerName || 'Customer'}</strong>, welcome to Benne Cafe Valet! 👋</p>
        ...
        <tr>
          <td style="background:#F9FAFB;border-top:1px solid #E5E7EB;padding:20px 32px;text-align:center;">
            ...
            <p style="margin:8px 0 0;font-size:13px;color:#6B7280;font-weight:600;">Team Benne Cafe</p>
          </td>
        </tr>
  ...
  async sendArrivalNotification(toEmail, customerName, bookingId, otp) {
    ...
    const html = `
      ...
      <br/>
      <p><b>Note:</b> Do not share OTP with anyone except the Benne Cafe Valet driver.</p>
      <br/>
      <p>Thanks,<br/>Team Benne Cafe</p>
    `;
